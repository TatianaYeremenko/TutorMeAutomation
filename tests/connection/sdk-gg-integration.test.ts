...
describe("Checking SDK GGT integration: ", () => {
  ...
  it("Submit PA assigned tutoring request", async () => {
    ...
    await page.getByPlaceholder("Category").type("Math");
    await page.getByPlaceholder("Subject").type("Basic Math");
  ...
  it("Student receives GG teacher tutoring request and able to connect to a tutor", async () => {
    ...
    await s.page
      .locator('//div[contains(text(),"Teacher: ' + teacherFullName + '")]')
      .isVisible();
    await s.page
      .locator('//div[contains(text(),"Teacher: ' + teacherFullName + '")]')
      .click();
